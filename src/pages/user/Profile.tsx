...
export const Profile: React.FC = () => {
  ...
  const [language, setLanguage] = useState<'EN' | 'VN' | 'JA'>('EN');
        ...
        <div className="lg:col-span-8 lg:col-start-5 pt-4">
          ...
          {activeTab === 'active' && hasActiveStay && (
            <div className="space-y-12 animate-in fade-in duration-700">
              <div className="flex justify-between items-end border-b border-[#1A1A1A]/20 pb-4 mb-8">
                <h2 className="text-3xl font-serif text-[#1A1A1A]">Your <span className="italic text-[#D4AF37]">Current Stay</span></h2>
                <span className="text-[10px] uppercase tracking-[0.3em] bg-[#1A1A1A] text-white px-3 py-1 animate-pulse">Checked In</span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-[#1A1A1A] text-[#F9F8F6] p-8 border-none relative overflow-hidden">
                  ...
                  <p className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#F9F8F6]/60 mb-2">Room Details</p>
                ...
                <Card className="p-8 border border-[#1A1A1A]/10 hover:border-[#D4AF37]/50 transition-colors group">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#6C6863] mb-2">Digital Access</p>
                      <h4 className="text-xl font-serif text-[#1A1A1A] mb-1">Wi-Fi Credentials</h4>
                      <p className="text-sm text-[#1A1A1A]">Network: <span className="font-bold">Lumiere_Guest</span></p>
                      <p className="text-sm text-[#1A1A1A] mb-6">Password: <span className="font-mono text-[#D4AF37]">LUM#402!X</span></p>
                    </div>
              ...
              <Card className="p-8 border-none bg-white shadow-[0_8px_32px_rgba(0,0,0,0.03)]">
                <p className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#6C6863] mb-6 border-b border-[#1A1A1A]/10 pb-2">Live Folio / Billing</p>
                <div className="space-y-4">
                  <div className="flex justify-between text-sm">
                    <span className="text-[#6C6863]">Room Rate (3 nights)</span>
                    <span className="text-[#1A1A1A] font-serif">$1,350.00</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[#6C6863]">In-Room Dining (Oct 13)</span>
                    <span className="text-[#1A1A1A] font-serif">$85.50</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[#6C6863]">Spa Services (Oct 14)</span>
                  ...
                  <div className="pt-4 mt-4 border-t border-[#1A1A1A]/10 flex justify-between items-center">
                    <span className="font-bold text-[#1A1A1A] uppercase tracking-[0.1em] text-xs">Current Balance</span>
            ...
            <div className="space-y-16 animate-in fade-in duration-700">
              ...
              <div>
                <div className="border-b border-[#1A1A1A]/20 pb-4 mb-8">
                  <h2 className="text-3xl font-serif text-[#1A1A1A]">Upcoming <span className="italic text-[#D4AF37]">Reservations</span></h2>
                </div>
                      ...
                      <div className="md:col-span-8 p-8 flex flex-col justify-between">
                        <div>
                          <div className="flex justify-between items-start mb-4">
                            <span className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#6C6863]">Conf# {booking.id}</span>
                          ...
                          <p className="text-lg font-serif text-[#1A1A1A]">Total Cost: <span className="text-[#D4AF37]">{booking.price}</span></p>
                        </div>

                        <div className="mt-8 pt-6 border-t border-[#1A1A1A]/10 flex flex-col sm:flex-row gap-4">
                          <Button variant="secondary" className="w-full sm:w-auto h-10 px-6">Modify Reservation</Button>
                          <Button variant="ghost" className="w-full sm:w-auto h-10 px-6 border border-[#1A1A1A]/20 text-red-700 hover:bg-red-50 hover:border-red-200">Cancel Booking</Button>
                        </div>
                      </div>
                    </div>
                  </Card>
              ...
              <div className="pt-4">
                <div className="border-b border-[#1A1A1A]/20 pb-4 mb-8">
                  <h2 className="text-3xl font-serif text-[#1A1A1A]">Past <span className="italic text-[#6C6863]">Stays</span></h2>
                </div>
          ...
          {activeTab === 'profile' && (
            <div className="space-y-12 animate-in fade-in duration-700 max-w-2xl">
               <div>
                 <h2 className="text-3xl font-serif text-[#1A1A1A] border-b border-[#1A1A1A]/20 pb-4 mb-8">Personal <span className="italic text-[#D4AF37]">Details</span></h2>
                 <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <label className="text-[10px] uppercase tracking-[0.2em] font-medium text-[#6C6863] mb-2 block">First Name</label>
                    ...
                    <div>
                      <label className="text-[10px] uppercase tracking-[0.2em] font-medium text-[#6C6863] mb-2 block">Last Name</label>
                    ...
                    <div className="md:col-span-2">
                      <label className="text-[10px] uppercase tracking-[0.2em] font-medium text-[#6C6863] mb-2 block">Email Address</label>
                    ...
                    <div className="md:col-span-2">
                      <label className="text-[10px] uppercase tracking-[0.2em] font-medium text-[#6C6863] mb-2 block">Phone Number</label>
               ...
               <div className="pt-8">
                 <h2 className="text-3xl font-serif text-[#1A1A1A] border-b border-[#1A1A1A]/20 pb-4 mb-8">Account <span className="italic text-[#6C6863]">Settings</span></h2>
                 ...
                 <div className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 border border-[#1A1A1A]/10 bg-white">
                      <div>
                        <p className="font-serif text-[#1A1A1A] text-lg">Language Preference</p>
                        <p className="text-xs text-[#6C6863] mt-1">Select your preferred communication language</p>
                      </div>
                 ...
                 <div className="mt-12 flex justify-end">
                   <Button variant="primary" className="bg-[#D4AF37] text-white py-4 hover:bg-[#D4AF37]/90 px-8">Save Changes</Button>
                 </div>
               </div>
            </div>
          )}
          ...
          {activeTab === 'payment' && (
             <div className="space-y-8 animate-in fade-in duration-700 max-w-2xl">
                <div className="flex justify-between items-end border-b border-[#1A1A1A]/20 pb-4 mb-8">
                  <h2 className="text-3xl font-serif text-[#1A1A1A]">Payment <span className="italic text-[#D4AF37]">Methods</span></h2>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <Card key={pm.id} className="p-6 border border-[#1A1A1A]/10 bg-white flex justify-between items-center group">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] uppercase tracking-widest text-[#6C6863] mt-1">Expires {pm.exp}</p>
                        </div>
                      </div>
                      <button className="text-xs text-[#6C6863] hover:text-red-600 transition-colors uppercase tracking-[0.2em] font-medium border-b border-transparent hover:border-red-600">Remove</button>
                    </Card>
                  ))}
                  ...
                  <button className="w-full py-8 border border-dashed border-[#1A1A1A]/20 bg-transparent hover:bg-[#1A1A1A]/5 transition-colors flex flex-col items-center justify-center gap-3 text-[#6C6863] hover:text-[#1A1A1A]">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-[0.2em]">Add New Payment Method</span>
                  </button>
                </div>
             </div>
          )}
          ...
          {activeTab === 'preferences' && (
             <div className="space-y-12 animate-in fade-in duration-700 max-w-2xl">
                <div className="border-b border-[#1A1A1A]/20 pb-4 mb-8">
                  <h2 className="text-3xl font-serif text-[#1A1A1A]">Guest <span className="italic text-[#D4AF37]">Preferences</span></h2>
                  <p className="text-sm text-[#6C6863] mt-2 font-serif italic">Help us tailor your stays to perfection.</p>
                </div>
                ...
                <div className="space-y-12">
                  ...
                  {/* Room Requirements */}
                  <div>
                    <h3 className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#1A1A1A] mb-6">Room Requirements</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {['High Floor', 'Near Elevator', 'Away from Elevator', 'Accessibility Needs', 'Extra Pillows', 'Firm Mattress'].map(pref => (
                        <label key={pref} className="flex items-center gap-4 p-4 border border-[#1A1A1A]/10 bg-white cursor-pointer hover:border-[#D4AF37]/50 transition-colors">
                          <input type="checkbox" className="w-4 h-4 rounded-none text-[#D4AF37] focus:ring-[#D4AF37] focus:ring-offset-0 border-[#1A1A1A]/20" />
                          <span className="text-sm text-[#1A1A1A] font-serif">{pref}</span>
                        </label>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#1A1A1A] mb-6">Dietary Restrictions</h3>
                    <textarea 
                      placeholder="Please specify any allergies or dietary requirements for our culinary team..."
                  ...
                  <div>
                    <h3 className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#1A1A1A] mb-6">Notification Settings</h3>
                    <div className="space-y-4">
                      <label className="flex justify-between items-center p-4 border border-[#1A1A1A]/10 bg-white cursor-pointer">
                        <div>
                          <p className="text-sm font-bold text-[#1A1A1A] uppercase tracking-wider text-[11px] mb-1">Email Alerts</p>
                          <p className="text-xs text-[#6C6863] font-serif">Booking confirmations and stay updates</p>
                        </div>
                        <input type="checkbox" defaultChecked className="w-5 h-5 rounded-none text-[#D4AF37] focus:ring-[#D4AF37] border-[#1A1A1A]/20" />
                      </label>
                      <label className="flex justify-between items-center p-4 border border-[#1A1A1A]/10 bg-white cursor-pointer">
                        <div>
                          <p className="text-sm font-bold text-[#1A1A1A] uppercase tracking-wider text-[11px] mb-1">SMS Notifications</p>
                          <p className="text-xs text-[#6C6863] font-serif">Digital key access and real-time room readiness</p>
                        </div>
                        <input type="checkbox" defaultChecked className="w-5 h-5 rounded-none text-[#D4AF37] focus:ring-[#D4AF37] border-[#1A1A1A]/20" />
                      </label>
                    </div>
                  ...
                  <div className="flex justify-end pt-8">
                    <Button variant="primary" className="bg-[#1A1A1A] text-white hover:bg-[#D4AF37] px-8 transition-colors duration-500">Update Preferences</Button>
                  </div>
