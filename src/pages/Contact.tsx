        ...
        <div className="pt-24 pb-40 bg-[#F9F8F6]">
            ...
            <div className="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center bg-[#1A1A1A]">
                ...
                <div className="relative z-10 text-center flex flex-col items-center justify-center w-full px-8">
                    <span className="block text-[10px] uppercase font-bold tracking-[0.3em] text-[#D4AF37] mb-6">Here To Assist You</span>
                    <h1 className="text-5xl md:text-[6rem] tracking-tight leading-[0.9] font-serif mb-6 text-[#F9F8F6] drop-shadow-xl">
            ...
            <div className="max-w-[1600px] mx-auto px-8 md:px-16 pt-24 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                {/* Left Column: Form */}
                <div>
                    <h2 className="text-3xl lg:text-4xl font-serif text-[#1A1A1A] mb-8">Send us a <span className="italic text-[#D4AF37]">message.</span></h2>
                    
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="flex flex-col">
                                <label className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#6C6863] mb-2">Full Name</label>
                            ...
                            <div className="flex flex-col">
                                <label className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#6C6863] mb-2">Email Address</label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="flex flex-col">
                                <label className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#6C6863] mb-2">Phone Number <span className="lowercase normal-case font-normal">(Optional)</span></label>
                            ...
                            <div className="flex flex-col">
                                <label className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#6C6863] mb-2">Subject</label>
                                <select required className="w-full bg-transparent border-b border-[#1A1A1A]/20 py-3 outline-none focus:border-[#D4AF37] transition-colors font-serif text-lg text-[#1A1A1A] appearance-none cursor-pointer">
                                    ...
                                    <option value="Reservation Modification">Reservation Modification</option>
                        ...
                        <div className="flex flex-col">
                            <label className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#6C6863] mb-2">Message Body</label>
                            <textarea required rows={6} className="w-full bg-transparent border-b border-[#1A1A1A]/20 py-3 outline-none focus:border-[#D4AF37] transition-colors font-serif text-lg text-[#1A1A1A] resize-none" placeholder="How can we assist you today?"></textarea>
                        </div>
                ...
                <div className="space-y-12">
                    ...
                    {/* Location Block */}
                    <div>
                        <h3 className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#D4AF37] mb-6 pb-2 border-b border-[#1A1A1A]/10">Property Location</h3>
                        <p className="font-serif text-xl text-[#1A1A1A] leading-relaxed mb-6">124 Luxury Avenue<br/>Historic District, Metropolis 10001</p>
                        
                        {/* Embedded Interactive Map (Google Maps iframe) */}
                        <div className="w-full h-[300px] bg-[#1A1A1A]/5 mb-6 relative grayscale hover:grayscale-0 transition-all duration-700 border border-[#1A1A1A]/10">
                            <iframe 
                        ...
                        <h4 className="text-xs uppercase tracking-[0.1em] font-bold text-[#1A1A1A] mb-3">Directions</h4>
                        <ul className="text-[#6C6863] space-y-2 text-sm font-serif italic mb-2">
                            <li>• <strong className="font-sans not-italic uppercase text-[10px] text-[#1A1A1A]">From Metropolis International Airport:</strong><br/>40 minutes via I-90 West, or let us arrange private airport transfer.</li>
                            <li className="pt-2">• <strong className="font-sans not-italic uppercase text-[10px] text-[#1A1A1A]">From Central Grand Train Station:</strong><br/>10 minutes via Metro Line A to Luxury Ave Station.</li>
                        </ul>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                        <div>
                            <h3 className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#D4AF37] mb-6 pb-2 border-b border-[#1A1A1A]/10">Direct Contact</h3>
                            <div className="space-y-5">
                                <div>
                                    <p className="text-[10px] uppercase font-bold tracking-[0.1em] text-[#6C6863]">Front Desk <span className="lowercase normal-case tracking-normal">(24/7)</span></p>
                                    <a href="tel:+15551234567" className="font-serif text-lg text-[#1A1A1A] hover:text-[#D4AF37] transition-colors">+1 (555) 123-4567</a>
                                </div>
                                <div>
                                    <p className="text-[10px] uppercase font-bold tracking-[0.1em] text-[#6C6863]">Reservations Department</p>
                                    <a href="tel:+15559876543" className="font-serif text-lg text-[#1A1A1A] hover:text-[#D4AF37] transition-colors">+1 (555) 987-6543</a>
                                </div>
                                <div>
                                    <p className="text-[10px] uppercase font-bold tracking-[0.1em] text-[#6C6863]">Official Email</p>
                        ...
                        <div>
                            <h3 className="text-[10px] uppercase font-bold tracking-[0.3em] text-[#D4AF37] mb-6 pb-2 border-b border-[#1A1A1A]/10">Support & Links</h3>
